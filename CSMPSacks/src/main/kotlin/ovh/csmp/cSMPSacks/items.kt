...
object items {
    ...
    val magic_wand = item("Magic Wand", "magic_wand", 1003, "COMMON", Material.STICK, listOf("Harry Potter wand from wish.com", "Right click and have a 10% chance to", "get a Tier 1 Ability"), true)
    ...
    val ability_shard = item("Ability Shard", "ability_shard", 1005, "UNCOMMON", Material.AMETHYST_SHARD, listOf("Once a dead man held this,", "and he got a cool lil ability", "Right click to have a 10% chance to", "get a Tier 2 Ability"), true)
}
